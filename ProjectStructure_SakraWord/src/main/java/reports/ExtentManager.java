...
public class ExtentManager {
	...
	public static ExtentReports getReports() {
		if (reports == null) {
			...
			String reportsFolder = d.toString().replaceAll(":", "-")+"\\screenshots"; //code to create screenshots folder
			
			String screenshotPath = System.getProperty("user.dir") +"\\reports\\" + reportsFolder;
			String reportPath = System.getProperty("user.dir") +"\\reports\\" + d.toString().replaceAll(":", "-"); //path for extent report
